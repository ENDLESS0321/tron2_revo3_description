"""Render V3's actual base, radial upright and top plate, without a camera."""
...
ax.set_title("V3: base + solid radial stem + directly connected plate")
...
side.set(xlabel="Y [mm]",ylabel="Z [mm]",title="Local CAD; assembly root rotates +90° about Y")
side.legend(loc="lower right")
fig.suptitle(f"V3 | radial length {m['parameters']['length_mm']:g} mm | plate {m['parameters']['plate_tilt_deg']:g} degrees | camera separate")
